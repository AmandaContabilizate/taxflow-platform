...
/* -------------------------------------------------------------------------- */
/*  Lectura tolerante del JSON de cálculos                                     */
/* -------------------------------------------------------------------------- */
...
function indexOf(obj: Json | null | undefined): Map<string, unknown> {
...
function resolvePath(obj: Json | null | undefined, path: string): unknown {
...
function pick(data: Json | null, candidates: string[]): unknown {
...
function subObject(root: Json | null, candidates: string[]): Json | null {
  if (!root) return null
